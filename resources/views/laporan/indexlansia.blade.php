          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center mb-3">
                <!-- Form pencarian -->
                <form method="GET" action="/laporanlansia" class="d-flex flex-grow-1">
                ...
                <a href="{{ route('periksa_lansias.pdf', ['bulan_awal' => request()->input('bulan_awal')]) }}" class="btn btn-secondary btn-sm ms-3">
