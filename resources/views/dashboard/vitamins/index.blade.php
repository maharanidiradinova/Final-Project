...
@section('container')
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Data Vitamin A</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="/dashboard">Home</a></li>
            <li class="breadcrumb-item"><a href="/dashboard/vitamins">Vitamin A</a></li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <!-- Form pencarian -->
                            <form method="GET" action="{{ route('vitamins.index') }}" class="d-flex flex-grow-1">
                            ...
                            <a href="{{ route('vitamins.create') }}" class="btn btn-primary btn-sm ms-3">Create</a>
                        </div>
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/dashboard/vitamins/{{ $vitamin->id }}/edit" class="btn btn-success"><i class="far fa-edit"></i></a>
                                        <form action="/dashboard/vitamins/{{ $vitamin->id }}" method="post" class="d-inline">
                                            @method('delete')
                                            @csrf
