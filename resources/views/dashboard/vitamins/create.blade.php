...
@section('container')
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Tambah Data Vitamin A</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="/dashboard">Home</a></li>
            <li class="breadcrumb-item"><a href="/dashboard/vitamins">Vitamin A</a></li>
            <li class="breadcrumb-item active">Tambah Data Vitamin A</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Vitamin A Anak</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form method="POST" action="/dashboard/vitamins" class="mb-5">
              @csrf
              <div class="card-body">
                <div class="row">
                   <!-- Pilih Anak -->
              ...
              <div class="card-footer">
                ...
                <a href="{{ route('vitamins.index') }}" class="btn btn-secondary">Kembali</a>
              </div>
            </form>
          </div>
          <!-- /.card -->
